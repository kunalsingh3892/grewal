...
class ViewMCQ2 extends StatefulWidget {
  final Object argument;

  const ViewMCQ2({Key key, this.argument}) : super(key: key);

  @override
  _LoginWithLogoState createState() => _LoginWithLogoState();
}

class _LoginWithLogoState extends State<ViewMCQ2> {
  ...
  void initState() {
    ...
    total_question = data['total_question'].toString();
    reattempt = data['reattempt'].toString();
    print(reattempt.toString() + " arr");
    _getUser();
  }
  ...
  Future _getTestData() async {
    ...
    var response = await http.post(
      new Uri.https(BASE_URL, API_PATH + "/check-result-new"),
      body: {
        "test_id": test_id,
        "user_id": user_id,
        "reattempt": reattempt.toString()
      },
      headers: headers,
    );
    print(jsonEncode({
